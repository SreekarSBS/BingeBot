...
const GptSearchBar = () => {
 const {searchText,
  ...
  return (
    ...
    <div className=" pt-[10%] sm:pt-[5%]  flex flex-col items-center">
    <h1 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl flex flex-col text-pink-600 font-black underline-offset-8 underline z-50 py-12 font-stretch-125% ">Search Recommendations</h1>
